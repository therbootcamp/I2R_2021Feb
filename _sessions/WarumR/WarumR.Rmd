...
<table style="cellspacing:0; cellpadding:0; border:none; width:70%">
  ...
  <td style="padding:20px;text-align:center">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Microsoft_Excel_Logo.svg/2000px-Microsoft_Excel_Logo.svg.png" height = 150px>
  </td>
  <td style="padding:20px;text-align:center">
...
<tr style="padding:20px;background-color:white">
  ...
  <td style="padding:20px;text-align:center">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/JASP_logo.svg/1200px-JASP_logo.svg.png" height = 150px>
  </td>
  <td style="padding:20px;text-align:center">
